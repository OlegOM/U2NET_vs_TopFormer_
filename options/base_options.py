...
class parser(object):
    def __init__(self):
        ...
        if self.continue_train:
            ...
            # self.unet_checkpoint = "drive/MyDrive/ClothTest/prev_checkpoints/cloth_segm_unet_surgery.pth"
            self.unet_checkpoint = "results/training_cloth_segm_u2net_exp1/checkpoints/itr_00013000_u2net_train_split_4.pth"
